...
For all support questions, ask in our [Discord](https://www.discord.me/3qshop) support chat. Do not create issues if you need help. Issues are for bug reporting and new features only.

## Dependencies

- [QBCore](https://github.com/qbcore-framework/qb-core)
- [3q_thermite](https://github.com/themysticg/3q_thermite)
- [3q_ui](https://github.com/themysticg/3q_ui)
