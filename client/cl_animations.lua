RegisterNetEvent('3q_chopshop:wheelanimation')
AddEventHandler('3q_chopshop:wheelanimation', function()
...
RegisterNetEvent('3q_chopshop:dooranimation')
AddEventHandler('3q_chopshop:dooranimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('3q_chopshop:trunkanimation')
AddEventHandler('3q_chopshop:trunkanimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('3q_chopshop:hoodanimation')
AddEventHandler('3q_chopshop:hoodanimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('3q_chopshop:wheelchopanim')
AddEventHandler('3q_chopshop:wheelchopanim', function()
	local ped = PlayerPedId()
	...
	exports["wsemotes"]:EmoteCommandStart("weld")
	Citizen.Wait(12000)
	ClearPedTasks(ped)
...
RegisterNetEvent('3q_chopshop:doorchopanim')
AddEventHandler('3q_chopshop:doorchopanim', function()
	local ped = PlayerPedId()    
...
RegisterNetEvent('3q_chopshop:hoodchopanim')
AddEventHandler('3q_chopshop:hoodchopanim', function()
	local ped = PlayerPedId()    
...
RegisterNetEvent('3q_chopshop:trunkchopanim')
AddEventHandler('3q_chopshop:trunkchopanim', function()
	local ped = PlayerPedId()
