...
Config.Email = false -- The sent number plate comes to your phone as an e-mail. If you are going to use NC UI, make it false.

Config.Fuel = 'cdn-fuel'

--Config.StartLoc = vector4(-552.0936, -1792.5475, 22.3643, 67.7999)  -- Starting Location with target and PED
Config.PedLocation = vector4(198.03317, -2201.57, 6.9717364, 359.49627)
Config.Ped = "a_m_m_indian_01"
